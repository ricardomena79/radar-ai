...
def test_archivos_protegidos_sin_diff():
    ...
    # `learned_evidence.py` (consulta genérica v1/v2) -- explícitamente
    # autorizados y documentados en el plan. Cualquier OTRO archivo de
    # `atlas_live/learning` sigue disparando el guard.
